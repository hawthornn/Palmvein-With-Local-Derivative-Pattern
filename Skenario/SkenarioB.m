%% Source Code Tugas Akhir Skenario B (Akhmad Faizal Akbar 1103110183)
% Dataset CASIA Menggunakan 850nm tangan kiri

%% Deskripsi Skenario B
...
for i=1:nData
    ...
    for j=1:nPalm
        ...
        feature{r,c} = LDPsc(vein,0,1);
        feature{r,c+1} = LDPsc(vein,45,1);
        feature{r,c+2} = LDPsc(vein,90,1);
        feature{r,c+3} = LDPsc(vein,135,1);
